                ...
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            <p class="text-sm mb-4 text-capitalize">Jumlah Pelajar Berojt(Tahun Ini)</p>
            ...
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            <p class="text-sm mb-0 text-capitalize">Tarikh Mula dan Tamat OJT(Tahun Ini)</p>
                            <h4 class="mb-0">Tarikh 1 ~ Tarikh 2</h4>
                        </div>
                    </div>
                    <hr class="dark horizontal my-0">
                    <div class="card-footer p-3">
